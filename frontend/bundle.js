...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fontAwesomeWebpack = __webpack_require__(14);

	var _fontAwesomeWebpack2 = _interopRequireDefault(_fontAwesomeWebpack);

	var _rich = __webpack_require__(25);

	var _rich2 = _interopRequireDefault(_rich);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./rich.styl", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./rich.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _aside = __webpack_require__(209);
	...
	_store2.default.dispatch((0, _actions.pullShopListPage)((0, _api.fetchShopListPage)()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(197),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(205),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Aside = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement('aside', { className: 'aside' });
	    }
	});
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'h1',
	                { id: 'header-title', className: 'header-item' },
	                'MALEE'
	            ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBox = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'form',
	            { id: 'search-bar', className: 'header-item' },
	            _react2.default.createElement('input', { className: 'search-input', name: 'q', type: 'text' }),
	            _react2.default.createElement(
	                'button',
...
/***/ function(module, exports) {
	...
	exports.pullShopListPage = pullShopListPage;
	exports.pullShopDetail = pullShopDetail;
	...
	var PULL_SHOP_LIST_PAGE = exports.PULL_SHOP_LIST_PAGE = 'PULL_SHOP_LIST_PAGE';
	function pullShopListPage(promise) {
	    return {
	...
	var PULL_SHOP_DETAIL = exports.PULL_SHOP_DETAIL = 'PULL_SHOP_DETAIL';
	function pullShopDetail(shop_id, promise) {
	    return {
	        type: PULL_SHOP_DETAIL,
	        shop_id: shop_id, promise: promise
	    };
	}

	var PULL_ITEM_LIST_PAGE = exports.PULL_ITEM_LIST_PAGE = 'PULL_ITEM_LIST_PAGE';
	function pullItemListPage(shop_id, promise) {
	    return {
	...
	var SELECT_SHOP = exports.SELECT_SHOP = 'SELECT_SHOP';
	function selectShop(shop_id) {
	    return {
	        type: SELECT_SHOP,
	        shop_id: shop_id
	    };
	...
	var EXIT_SHOP = exports.EXIT_SHOP = 'EXIT_SHOP';
	function exitShop() {
	    return {
	        type: EXIT_SHOP
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shopList = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShopCard = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement('img', { className: 'shop-photo', src: this.props.shop.photo, alt: this.props.shop.name }),
	            _react2.default.createElement(
	                'h3',
	                { className: 'shop-name' },
	...
	var ShopList = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                this.state.shops.map(function (shop, index) {
	                    return _react2.default.createElement(ShopCard, {
	                        key: shop.id,
	                        delay: index > _this.state.delayBase ? index - _this.state.delayBase : 0,
	                        shop: shop,
	    ...
	    getInitialState: function getInitialState() {
	        ...
	        return {
	            shops: Object.getOwnPropertyNames(this.props.shops).filter(function (name) {
	                return !isNaN(parseInt(name, 10));
	            }).map(function (id) {
	                return _this2.props.shops[id];
	            }),
	            delayBase: 0
	        };
	    },
	    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	        this.setState({
	            shops: Object.getOwnPropertyNames(nextProps.shops).filter(function (name) {
	                return !isNaN(parseInt(name, 10));
	            }).map(function (id) {
	                return nextProps.shops[id];
	            }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShopInfo = _react2.default.createClass({
	    displayName: 'ShopInfo',

	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'shop-info ' + (this.props.fetching ? "shop-info-fetching" : "") },
	            _react2.default.createElement('img', { className: 'shop-photo', src: this.props.shop.photo, alt: this.props.shop.name }),
	            _react2.default.createElement(
	                'h3',
	                { className: 'shop-name' },
	                this.props.shop.name || "No Name"
	            ),
	            _react2.default.createElement(
	                'p',
	                { className: 'shop-phone' },
	                this.props.shop.phone || "No Phone"
	            ),
	            _react2.default.createElement(
	                'p',
	                { className: 'shop-address' },
	                this.props.shop.address || "No Address"
	            ),
	            _react2.default.createElement(
	                'p',
	                { className: 'shop-desc' },
	                this.props.shop.desc || "No Description"
	            )
	        );
	    }
	});
	...
	var Shop = _react2.default.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        if (!this.props.shop.detail) {
	            this.props.dispatch((0, _actions.pullShopDetail)(this.props.shopId, (0, _api.fetchShopDetail)(this.props.shopId)));
	        }
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Item = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'item-card-inner ' + (this.state.selected ? "selected" : "") },
	                _react2.default.createElement('img', { className: 'item-photo', src: this.props.item.photo, alt: this.props.item.name }),
	                _react2.default.createElement(
	                    'h4',
	                    { className: 'item-name' },
	                ...
	                _react2.default.createElement(
	                    'form',
	                    { className: 'item-number', onSubmit: function onSubmit(e) {
	    ...
	    changeNumber: function changeNumber(new_number) {
	        if (new_number < 0) {
	            new_number = 0;
	        }
	    ...
	    handleNumberChange: function handleNumberChange(event) {
	        var new_number = parseInt(event.target.value, 10) || 0;
	    ...
	    handleInc: function handleInc() {
	        this.changeNumber(this.state.number + 1);
	    },

	    handleDec: function handleDec() {
	        this.changeNumber(this.state.number - 1);
	    }
	});
	...
	var ItemList = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var ret = _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                this.props.items.filter(function (item, index) {
	                    return index < _this.state.rendered;
	    ...
	    showNext: function showNext() {
	        var rendered = this.state.rendered + 1;
	...
	var mapStateToProps = function mapStateToProps(state) {
	    return {
	        ...
	        items: Object.getOwnPropertyNames(state.items).filter(function (name) {
	            ...
	            return item.shop == state.currentShop;
	        })
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function presenting() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? 'SHOPS' : arguments[0];
	    var action = arguments[1];
	...
	function shopLastId() {
	    ...
	    switch (action.type) {
	        case Actions.PULL_SHOP_LIST_PAGE:
	            {
	                return action.ready && !action.error && action.result.shops.length ? action.result.shops[action.result.shops.length - 1].id + 1 : state;
	            }
	        default:
	            return state;
	    }
	...
	function items() {
	    ...
	    switch (action.type) {
	        case Actions.PULL_ITEM_LIST_PAGE:
	            {
	                return Object.assign({}, state, action.ready && !action.error ? action.result.items.reduce(function (map, item) {
	                    map[item.id] = item;
	                    return map;
	                }, {}) : {});
	            }
	    ...
	    return function (next) {
	        return function (action) {
	            ...
	            function makeAction(ready, data) {
	                var new_action = Object.assign({}, action, { ready: ready }, data);
